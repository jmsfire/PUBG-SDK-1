...
struct FSpriteGeometryShape
{
	...
	struct FVector2D                                   BoxSize;                                                  // 0x0018(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
	struct FVector2D                                   BoxPosition;                                              // 0x0020(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_EditConst, CPF_IsPlainOldData)
