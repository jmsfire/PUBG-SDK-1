...
namespace Classes {
	...
	public:
		...
		struct FVector                                     EndLocation;                                              // 0x07A8(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		...
		struct FVector                                     CableForce;                                               // 0x07CC(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
