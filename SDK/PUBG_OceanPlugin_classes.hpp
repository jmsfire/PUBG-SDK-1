...
public:
	...
	struct FVector                                     VelocityDamper;                                           // 0x0318(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TArray<struct FVector>                             TestPoints;                                               // 0x0330(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor)
	...
	struct FRotator                                    StayUprightDesiredRotation;                               // 0x0374(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector2D                                   GlobalWaveDirection;                                      // 0x03A4(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     VelocityDamper;                                           // 0x0158(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	TArray<struct FVector>                             TestPoints;                                               // 0x0170(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor)
	...
	struct FRotator                                    StayUprightDesiredRotation;                               // 0x019C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     VelocityDamper;                                           // 0x09E0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     underwaterMin;                                            // 0x0488(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     underwaterMax;                                            // 0x0494(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
