...
public:
	...
	struct FRotator                                    WheelRotation;                                            // 0x2FB8(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	struct FRotator                                    RPMArrowRotation;                                         // 0x2FD0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
