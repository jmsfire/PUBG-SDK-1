...
namespace Classes {
	...
	public:
		...
		struct FVector                                     LastVelocity;                                             // 0x0868(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     Acceleration;                                             // 0x0874(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
