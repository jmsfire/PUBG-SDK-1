...
namespace Classes {
	...
	public:
		...
		struct FRotator                                    KickStandRot;                                             // 0x1450(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		...
		struct FRotator                                    SteerROT;                                                 // 0x1478(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
