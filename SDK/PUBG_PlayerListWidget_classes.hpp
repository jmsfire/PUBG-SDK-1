...
public:
	...
	struct FVector                                     CurrentSpectatorPawnLocation;                             // 0x02F0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
